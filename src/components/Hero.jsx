...
import imgTennis from'../assets/img/hero.png';
...
function Hero() {
    ...
    return (
        ...
        <div className="bg-animation-color h-screen  justify-center z-10 m-0 p-0" >
            ...
            <div/>    
            <div className="p-0 m-0 div-img"><img src={imgTennis} id="imgTenis"  className="img-page h-64 md:h-48 sm:h-40 sm:ml-6 md:mt-10 sm:mt-14" alt="" /></div>
