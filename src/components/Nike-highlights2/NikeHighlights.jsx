...
function NikeHighlights2 () {
    ...
    return (
        <>
            <div className="flex flex-row-reverse justify-end p-10">
                <div className="highlights-left "><img className="object-fill ml-0 pl-0 transitions-theme h-72 rotate-6 hover:-rotate-12" src={product3} alt="" /></div>
