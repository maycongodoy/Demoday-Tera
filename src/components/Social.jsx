...
function Social () {
        return (
            <div className="py-6 px-4 bg-theme-social flex justify-center dark:bg-gray-700 md:flex md:items-center md:justify-between">
            
            <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                <span className="text-sm text-gray-100 dark:text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com/">Godoy e Castilho™</a>. Todos os direitos reservados.</span>
