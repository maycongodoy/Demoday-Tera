...
import imghighlights from '../Nike-highlights/hightlightimg.png'
    ...
    return (
        <>
            <div className="flex items-center justify-between p-10">
                <div className="highlights-left"><img className="w-auto object-fill transitions-theme h-60 rotate-6 hover:-rotate-12" src={imghighlights} alt="" /></div>
                <div className="highlights-right w-1/2">
