...
function Hero() {
  return (
    <>
      ...
      <div className='relative opacity-100 z-20 grid items-center justify-items-center nav-container'></div>
        <div className="grid items-center justify-items-center mt-28 md:mt-24">
          <h1 className="text-6xl lg:text-5xl md:text-4xl sm:text-3xl xsm:text-2xl font-extrabold filter drop-shadow-sm text-slate-900">
          Os Melhores Tênis
          </h1>
        </div>
        ...
        <div className="pt-20 w-4/5 flex  color-azure translate-x-40 justify-between ">
          ...
          <div />
          <div className="p-0 m-0 div-img">
            <img
              src={imageTennis}
              id="imageTenis"
              className="img-page h-60 "
              alt=""
            />
          </div>
